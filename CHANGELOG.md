...
- Added (minor): **snapshot**, **commit backstop**, **backlink-safe rename** (Architecture terms); **sync** (User-facing verbs); **wired source** (Vault management terms); **superseded** (Ingest and memory terms).
