...
# Shared awk float-math (ratio / meets / meets_ratio / min_ratio), single-sourced
...
# Float-math helpers (ratio / meets / meets_ratio / min_ratio) are sourced from
# the shared lib below so eval-query.sh computes identical numbers from one
# source of truth (ADR-0017). See scripts/lib-eval-float.sh.
