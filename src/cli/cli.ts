 ...
 */
type OllamaStatus = "up" | "down" | "unprobed";
 ...
 */
type ClaudeStatus = "reachable" | "unreachable" | "unprobed";
 ...
 * absent or blank.
 */
function parseOtherVaults(otherVaults: string | undefined): readonly string[] {
