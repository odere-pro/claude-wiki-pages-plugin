...
The environment health check (`/claude-wiki-pages:doctor`, `scripts/doctor.sh`). Read-only by contract; exit codes 0–5.

## Key Principles

- The environment health check (`/claude-wiki-pages:doctor`, `scripts/doctor.sh`).
