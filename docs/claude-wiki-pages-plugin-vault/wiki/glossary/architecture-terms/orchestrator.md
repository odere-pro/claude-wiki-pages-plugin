...
The Layer 4 entry agent (`claude-wiki-pages-orchestrator-agent`). Probes vault state; dispatches to one specialist per invocation.

## Key Principles

- The Layer 4 entry agent (`claude-wiki-pages-orchestrator-agent`).
