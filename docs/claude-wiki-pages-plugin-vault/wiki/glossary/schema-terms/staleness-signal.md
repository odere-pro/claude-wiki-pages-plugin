...
Any indicator — elapsed time, missing sources, or low confidence — that a page may no longer reflect its raw sources. Surfaced by lint and the curator's staleness check.

## Key Principles

- Any indicator — elapsed time, missing sources, or low confidence — that a page may no longer reflect its raw sources.
