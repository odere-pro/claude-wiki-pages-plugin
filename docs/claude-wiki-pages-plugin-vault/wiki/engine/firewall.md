...
related: ["[[multi-vault-registry|Multi-Vault Registry]]", "[[vault-resolution|Vault Resolution]]", "[[deterministic-engine|Deterministic Engine]]", "[[active-vault|Active Vault]]", "[[hook-system|Hook System]]", "[[scripts-layer|Scripts Layer]]"]
tags: ["tool", "security"]
created: 2026-06-13
updated: 2026-06-13
update_count: 7
...
- [[multi-vault-registry|Multi-Vault Registry]] — the registry the firewall reads for `otherVaults`
...
- [[hook-system|Hook System]] — the broader `PreToolUse` hook chain that fires the firewall
