...
parent: "[[Engine — Index]]"
path: "engine"
sources: ["[[propose.ts Source]]", "[[Engine API Skill (SKILL.md)]]"]
related: ["[[Deterministic Engine]]", "[[Engine Verb Surface]]", "[[Git Checkpoint]]"]
contradicts: []
supersedes: []
...
- [[Engine Verb Surface]] — the full set of engine verbs this `propose` verb is part of
- [[Deterministic Engine]] — the engine providing this review surface
