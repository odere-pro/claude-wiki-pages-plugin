...
- [[Host-Project Intake]] — primary decision page
- [[Ingest Agent]] — recursive enumeration via `backlog --json`
- [[Ingest Pipeline]] — updated first-class intake flow
- [[Wired Source]] — intake reuses wire-source globs
