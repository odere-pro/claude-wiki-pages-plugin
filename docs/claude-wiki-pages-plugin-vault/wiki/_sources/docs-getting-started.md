...
- File: `raw/repo/docs/getting-started.md`
- Type: quickstart guide

## Summary

A flat list of CLI commands to go from nothing to querying a populated wiki: run Claude Code, install plugin, create vault, import raw files, run /wiki, check status, query, export as portable markdown.
