...
- (none new — all entities are existing pages)
...
- [[Schema Authority]] — one home: `skills/init/template/CLAUDE.md`
- [[Golden Set]] — moves to `tests/fixtures/reference-vault/`
- [[Parity Gate]] — ontology-profile.bats pins fixture↔template
