...
- [[Dangling Wikilink]] — WARN check contract
- [[Shell-TS Parity]] — gate-05 parity contract for dangling-wikilink rule
- [[Deterministic Engine]] — verify gains dangling-wikilink WARN check
- [[Graph Quality]] — dangling scanner promoted into verify path
