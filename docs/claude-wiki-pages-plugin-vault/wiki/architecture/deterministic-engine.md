...
parent: "[[Architecture]]"
path: "architecture"
sources: ["[[Architecture Documentation]]", "[[Glossary]]", "[[ADR-0015: Engine Self-Description Surfaces]]", "[[ADR-0005: Git Required Per-Vault Init]]"]
related: ["[[Four-Layer Stack]]", "[[Wiki-Native Recall]]", "[[Graph Traversal Primitive]]", "[[Firewall]]", "[[Auto-Heal]]", "[[Lint Rules]]", "[[Local Model Quality Gate]]"]
tags: ["tool", "engine"]
created: 2026-06-13
updated: 2026-06-13
update_count: 5
