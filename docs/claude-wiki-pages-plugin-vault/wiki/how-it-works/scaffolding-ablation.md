...
related: ["[[local-model-quality-gate|Local Model Quality Gate]]", "[[golden-set|Golden Set]]", "[[plugin|claude-wiki-pages Plugin]]", "[[ingest-pipeline|Ingest Pipeline]]", "[[approved-local-model|Approved Local Model]]", "[[no-rag-principle|NO-RAG Principle]]"]
...
- [[local-model-quality-gate|Local Model Quality Gate]] — the gate that uses the same golden-set methodology for the plugin arm
- [[golden-set|Golden Set]] — the checked-in fixtures used for both arms
- [[plugin|claude-wiki-pages Plugin]] — the plugin whose scaffolding is being measured
- [[no-rag-principle|NO-RAG Principle]] — scoring in both arms is exact structural comparison, never embedding
