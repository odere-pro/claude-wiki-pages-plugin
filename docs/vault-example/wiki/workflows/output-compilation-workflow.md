...
sources:
  - "[[Export Outputs]]"
related: ["[[Query Workflow]]", "[[Pandoc]]", "[[claude-wiki-pages]]"]
contradicts: []
supersedes: []
depends_on: []
...
- Use `/claude-wiki-pages:claude-wiki-pages-analyst-agent compile <topic> for <audience>` to generate a cited deliverable.
...
- `/claude-wiki-pages:claude-wiki-pages-analyst-agent compile a 1-page brief on the [[LLM Wiki Pattern]] for a new teammate.`
