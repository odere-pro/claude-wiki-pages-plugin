...
#   claude -p /claude-wiki-pages:llm-wiki-ingest    --vault "$TMP_VAULT" ...
#   claude -p /claude-wiki-pages:llm-wiki-lint      --vault "$TMP_VAULT" ...
#   claude -p /claude-wiki-pages:llm-wiki-fix       --vault "$TMP_VAULT" ...
#   claude -p /claude-wiki-pages:llm-wiki-synthesize --vault "$TMP_VAULT" ...
#   claude -p /claude-wiki-pages:llm-wiki-markdown  --vault "$TMP_VAULT" ...
