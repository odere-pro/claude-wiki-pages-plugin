...
#   claude -p /claude-wiki-pages:ingest    --vault "$TMP_VAULT" ...
#   claude -p /claude-wiki-pages:lint      --vault "$TMP_VAULT" ...
#   claude -p /claude-wiki-pages:fix       --vault "$TMP_VAULT" ...
#   claude -p /claude-wiki-pages:synthesize --vault "$TMP_VAULT" ...
#   claude -p /claude-wiki-pages:markdown  --vault "$TMP_VAULT" ...
...
#
# The `markdown` skill writes here; we audit its output shape with
